...
document.getElementsByClassName("s drum")[0].addEventListener("click", function() {playAudio("sounds/tom-3.mp3")});
document.getElementsByClassName("a drum")[0].addEventListener("click", function(){playAudio("sounds/tom-2.mp3")});
